...
bool CSpider::Init(void) {
	...
	int nJointNum = sizeof(szJoint)/sizeof(szJoint[0]);
...
void CSpider::GetAllAngles() {
	printf("LEG_RF: %g %g %g\r\n", 
		m_szLeg[LEG_RF]->GetfAngle(CSpiderLeg::Hip),
		m_szLeg[LEG_RF]->GetfAngle(CSpiderLeg::Knee), 
		m_szLeg[LEG_RF]->GetfAngle(CSpiderLeg::Ankle));
	printf("LEG_RM: %g %g %g\r\n", 
		m_szLeg[LEG_RM]->GetfAngle(CSpiderLeg::Hip),
		m_szLeg[LEG_RM]->GetfAngle(CSpiderLeg::Knee),
		m_szLeg[LEG_RM]->GetfAngle(CSpiderLeg::Ankle));
	printf("LEG_RB: %g %g %g\r\n", 
		m_szLeg[LEG_RB]->GetfAngle(CSpiderLeg::Hip),
		m_szLeg[LEG_RB]->GetfAngle(CSpiderLeg::Knee),
		m_szLeg[LEG_RB]->GetfAngle(CSpiderLeg::Ankle));
	printf("LEG_LB: %g %g %g\r\n", 
		m_szLeg[LEG_LB]->GetfAngle(CSpiderLeg::Hip),
		m_szLeg[LEG_LB]->GetfAngle(CSpiderLeg::Knee), 
		m_szLeg[LEG_LB]->GetfAngle(CSpiderLeg::Ankle));
	printf("LEG_LM: %g %g %g\r\n", 
		m_szLeg[LEG_LM]->GetfAngle(CSpiderLeg::Hip),
		m_szLeg[LEG_LM]->GetfAngle(CSpiderLeg::Knee),
		m_szLeg[LEG_LM]->GetfAngle(CSpiderLeg::Ankle));
	printf("LEG_LF: %g %g %g\r\n", 
		m_szLeg[LEG_LF]->GetfAngle(CSpiderLeg::Hip),
		m_szLeg[LEG_LF]->GetfAngle(CSpiderLeg::Knee), 
		m_szLeg[LEG_LF]->GetfAngle(CSpiderLeg::Ankle));
}
...
void CSpider::MoveForward(uint8_t Repeat_Num) {
	if (m_bDebugDump)
		printf("[Spider]MoveForward %d\r\n", Repeat_Num);
	for(int num=0;num<Repeat_Num && m_bAbort!= true;num++) {
...
void CSpider::RotatelRight2(uint8_t Repeat_Num) {
	if (m_bDebugDump)
		printf("[Spider]RotatelRight2 %d\r\n", Repeat_Num);
	for(int num=0;num<Repeat_Num && m_bAbort!= true;num++) {
		if(m_szLeg[LEG_RM]->GetfAngle(CSpiderLeg::Hip)!=0 && m_szLeg[LEG_LM]->GetfAngle(CSpiderLeg::Hip)!=0)
			Reset();
		MoveTripod(TRIPOD1,CSpiderLeg::Knee,Knee_Up_Base,Knee_Up_Base,Knee_Up_Base);
		WaitReady(ReadyTime());
		MoveTripod(TRIPOD1,CSpiderLeg::Hip,HipF_Base-15,HipM_Base+15,HipB_Base-15);
		WaitReady(ReadyTime());
		MoveTripod(TRIPOD1,CSpiderLeg::Knee,Knee_Down_Base,Knee_Down_Base,Knee_Down_Base);
		WaitReady(ReadyTime());
		MoveTripod(TRIPOD2,CSpiderLeg::Knee,Knee_Up_Base,Knee_Up_Base,Knee_Up_Base);
...
void CSpider::RotatelLeft2(uint8_t Repeat_Num) {
	if (m_bDebugDump)
		printf("[Spider]Half RotatelLeft %d\r\n", Repeat_Num);
	for(int num=0;num<Repeat_Num && m_bAbort!= true;num++) {
		if(m_szLeg[LEG_RM]->GetfAngle(CSpiderLeg::Hip)!=0 && m_szLeg[LEG_LM]->GetfAngle(CSpiderLeg::Hip)!=0)
			Reset();
		MoveTripod(TRIPOD1,CSpiderLeg::Knee,Knee_Up_Base,Knee_Up_Base,Knee_Up_Base);
